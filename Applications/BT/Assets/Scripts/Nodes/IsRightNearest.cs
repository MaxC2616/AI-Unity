...
public class IsRightNearest : Node      //inherit from node
{
    ...
    public IsRightNearest(PlayerMovement ai, List<GameObject> NearGameobjects)  //upon creation, pass through AI object details and nearest game obstacles
    {
        this.ai = ai;
    ...
    public override NodeState Evaluate()
    {
        ...
        if (closestObject.tag == "TallFreeRight")   //if the tag of the closest obstacle is "TallFreeRight"
        {
        ...
        else               //if the closest object is not TallFreeRight, we return failure and move to next node.
        {
            //ai.running = false;
            return NodeState.FAILURE;
        }
